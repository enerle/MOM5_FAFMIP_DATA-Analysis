...
fn = os.path.join(datadir,'CORE_MOM_FAFMIP_CTL_ocean_fluxes_timmean.nc')
...
#plt.show()
plt.savefig('./Figures/sfc_hflux_budget_CORE.png',transparent = True, bbox_inches='tight',dpi=600)
...
filename2="/home/netapp-clima-users1/rfarneti/ANALYSIS/FAFMIP/Data_MOM1/OHT_CTL.nc"
...
filename3="/home/netapp-clima-users1/rfarneti/ANALYSIS/FAFMIP/Data_MOM1/heat_content_FAFMIP_CTL.nc"
...
ax.plot(YY,GLHT,'-',color='k',linewidth=3,label="OHT $[PW]$")
...
#plt.show()
plt.savefig('./Figures/sfc_hflux_budget_CORE_p2.png',transparent = True, bbox_inches='tight',dpi=600)

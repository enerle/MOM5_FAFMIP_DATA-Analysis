...
#plt.show()
plt.savefig('./Figures/ESTC_change_ATL.png',transparent = True, bbox_inches='tight',dpi=600)
...
#plt.show()
plt.savefig('./Figures/ESTC_change-ekmantransport_ATL.png',transparent = True, bbox_inches='tight',dpi=600)
...
#plt.show()
plt.savefig('./Figures/ESTC_change_taux_sst_ATL.png',transparent = True, bbox_inches='tight',dpi=600)
...
#plt.show()
plt.savefig('./Figures/ESTC_taux_sst_control_ATL.png',transparent = True, bbox_inches='tight',dpi=600)
...
#plt.show()
plt.savefig('./Figures/ESTC_dx_and_dy_width_ATL.png',transparent = True, bbox_inches='tight',dpi=600)
...
#plt.show()
plt.savefig('./Figures/ESTC_temp-gradient_ATL.png',transparent = True, bbox_inches='tight',dpi=600)
...
#plt.show()
plt.savefig('./Figures/ESTC_temp-zonal_ATL.png',transparent = True, bbox_inches='tight',dpi=600)
...
#plt.show()
plt.savefig('./Figures/ESTC_taux-zonal_ATL.png',transparent = True, bbox_inches='tight',dpi=600)

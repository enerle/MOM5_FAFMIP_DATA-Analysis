...
#plt.show()
plt.savefig('STC_OHC_PAC_diag_tend_online.png',transparent = False, bbox_inches='tight',dpi=300)
...
plt.xticks([0,1,2,3,4,5,6],["","Total","","Overturn","","Interior",""],fontsize=16,style='normal')
#plt.show()
plt.savefig('STC_OHC_PAC_diag_tend_online_CTL.png',transparent = False, bbox_inches='tight',dpi=300)

...
for i in range(len(exp)-1):
    ...
    ax.plot(0.8,resolved_glb[i]-resolved_glb[-1],          marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[1]) #resolved
    ...
    ax.plot(1.2,dia_swh_glb[i]-dia_swh_glb[-1],            marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[5]) #diapycnal 
    ax.plot(1.0,total_glb[i]-total_glb[-1],                marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[6]) #all
    ax.plot(1.0,remaining_glb[i]-remaining_glb[-1],        marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[7]) #remaining

    ax.plot(3.0,temptend_soc[i]-temptend_soc[-1],          marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[0])
    ax.plot(2.8,resolved_soc[i]-resolved_soc[-1],          marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[1])
    ...
    ax.plot(3.2,dia_swh_soc[i]-dia_swh_soc[-1],            marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[5])
    ax.plot(3.0,total_soc[i]-total_soc[-1],                marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[6])
    ax.plot(3.0,remaining_soc[i]-remaining_soc[-1],        marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[7])

    ax.plot(5.0,temptend_atl[i]-temptend_atl[-1],          marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[0])
    ax.plot(4.8,resolved_atl[i]-resolved_atl[-1],          marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[1])
    ...
    ax.plot(5.2,dia_swh_atl[i]-dia_swh_atl[-1],            marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[5])
    ax.plot(5.0,total_atl[i]-total_atl[-1],                marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[6])
    ax.plot(5.0,remaining_atl[i]-remaining_atl[-1],        marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[7])

    ax.plot(7.0,temptend_ipa[i]-temptend_ipa[-1],          marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[0])
    ax.plot(6.8,resolved_ipa[i]-resolved_ipa[-1],          marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[1])
    ...
    ax.plot(7.2,dia_swh_ipa[i]-dia_swh_ipa[-1],            marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[5])
    ax.plot(7.0,total_ipa[i]-total_ipa[-1],                marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[6])
    ax.plot(7.0,remaining_ipa[i]-remaining_ipa[-1],        marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[7])

    ax.plot(9.0,temptend_pac[i]-temptend_pac[-1],          marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[0])
    ax.plot(8.8,resolved_pac[i]-resolved_pac[-1],          marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[1])
    ax.plot(8.8,eddy_pac[i]-eddy_pac[-1],                  marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[2])
    ax.plot(8.8,residual_pac[i]-residual_pac[-1],          marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[3])
    ax.plot(9.2,isopycnal_mix_pac[i]-isopycnal_mix_pac[-1],marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[4])
    ax.plot(9.2,dia_swh_pac[i]-dia_swh_pac[-1],            marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[5])
    ax.plot(9.0,total_pac[i]-total_pac[-1],                marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[6])
    ax.plot(9.0,remaining_pac[i]-remaining_pac[-1],        marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[7])

    ax.plot(11.0,temptend_ind[i]-temptend_ind[-1],          marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[0],label=labels[0])
    ax.plot(10.8,resolved_ind[i]-resolved_ind[-1],          marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[1],label=labels[1])
    ax.plot(10.8,eddy_ind[i]-eddy_ind[-1],                  marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[2],label=labels[2])
    ax.plot(10.8,residual_ind[i]-residual_ind[-1],          marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[3],label=labels[3])
    ax.plot(11.2,isopycnal_mix_ind[i]-isopycnal_mix_ind[-1],marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[4],label=labels[4])
    ax.plot(11.2,dia_swh_ind[i]-dia_swh_ind[-1],            marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[5],label=labels[5])
    ax.plot(11.0,total_ind[i]-total_ind[-1],                marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[6],label=labels[6])
    ax.plot(11.0,remaining_ind[i]-remaining_ind[-1],        marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[7],label=labels[7])

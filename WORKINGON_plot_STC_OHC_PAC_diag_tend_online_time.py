...
filename = ["STC_temptend_FAFSTRESS_PAC.nc","STC_temptend_FAFWATER_PAC.nc","STC_temptend_FAFHEAT_PAC.nc","STC_temptend_flux-only_PAC.nc"]
...
v = [0,70,-.4,.4] #this is for the description
...
for i in range(len(exp)-1):
    ...
    #plt.show()
    plt.savefig('STC_OHC_PAC_diag_tend_online_time_' + exp[i] + '.png',transparent = False, bbox_inches='tight',dpi=300)
...
#plt.show()
plt.savefig('STC_OHC_PAC_diag_tend_online_time_CTL.png',transparent = False, bbox_inches='tight',dpi=300)

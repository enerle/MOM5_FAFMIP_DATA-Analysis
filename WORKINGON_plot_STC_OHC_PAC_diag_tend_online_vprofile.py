...
for i in range(len(exp)):
    ...
    potrho[i]   = np.mean(file.variables['POT_RHO_0_ZONALMEAN_PAC'][:,50:132]-1000.,axis=1)
    file.close()
...
#plt.show()
plt.savefig('STC_OHC_PAC_diag_tend_online_vprofile.png',transparent = False, bbox_inches='tight',dpi=300)
